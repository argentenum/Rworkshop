...
regexpr("uat","Equator") #gregexpr gregexpr("iss", "Mississipi") #sub
replace substring - only first instance sub("iss","ant","Mississipi")
#gsub replace substrings - all instances gsub("iss","ant","Mississipi")
